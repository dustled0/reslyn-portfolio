export default function Hero() {
  return (
    <section className="min-h-screen bg-indigo-950 flex items-center relative overflow-hidden">
      {/* Background glows */}
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-28 relative z-10 w-full">
        <div className="max-w-3xl">
          ...
          <p className="text-indigo-300 text-lg leading-relaxed mb-8 max-w-2xl">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <a
              href={`https://wa.me/639664833781?text=${encodeURIComponent(
                "Hi Reslyn! I found your portfolio and I'm interested in working with you."
              )}`}
              target="_blank"
              rel="noopener noreferrer"
              className="bg-green-500 hover:bg-green-400 text-white font-semibold px-8 py-3 rounded-lg transition-colors inline-flex items-center gap-2"
            >
            ...
            <a
              href="#experience"
              className="border border-indigo-700 hover:border-emerald-400 text-indigo-200 hover:text-emerald-400 font-semibold px-8 py-3 rounded-lg transition-colors"
            >
              See My Work
            </a>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <span className="text-indigo-500 text-xs uppercase tracking-widest">Find me on</span>
            <a
              href="https://www.linkedin.com/in/reslyn-dequito"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-indigo-300 hover:text-blue-400 transition-colors text-sm font-medium"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-indigo-300 hover:text-emerald-400 transition-colors text-sm font-medium"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-2 text-indigo-500 text-xs">
        <span>Scroll</span>
        <div className="w-px h-8 bg-linear-to-b from-indigo-500 to-transparent" />
      </div>
    </section>
  );
}
