      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-28 relative z-10 w-full">
        <div className="max-w-3xl">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            ...
            <a
              href="#experience"
              className="border border-slate-600 hover:border-amber-400 text-slate-300 hover:text-amber-400 font-semibold px-8 py-3 rounded-lg transition-colors"
            >
              See My Work
            </a>
          </div>
          ...
          <div className="flex flex-wrap items-center gap-4">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-slate-400 hover:text-blue-400 transition-colors text-sm font-medium"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-slate-400 hover:text-green-400 transition-colors text-sm font-medium"
            >
              <svg viewBox="0 0 24 24" fill="currentColor" className="w-4 h-4">
