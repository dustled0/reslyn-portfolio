    ...
    <section id="education" className="py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          <FadeIn delay={0.1}>
            <div className="bg-stone-50 rounded-2xl p-8 border border-stone-200 h-full">
          ...
          <FadeIn delay={0.2}>
            <div className="bg-amber-50 rounded-2xl p-8 border border-amber-200 h-full">
              <div className="w-12 h-12 bg-amber-200 rounded-xl flex items-center justify-center text-2xl mb-5">
                📜
              </div>
              <h3 className="font-bold text-stone-900 text-xl mb-1">
